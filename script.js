...
FDS.addEventListener('submit', function (event) {
    ...
    const rp = {
        ...
        HC : HC,
        VC : `<p>Để ổn định và duy trì khoáng chất bón (${URE} g urê, ${BSA} g SA, ${LNC} g Lân nung chảy, ${KCL} g KCl, ${BTE} g trung vi lượng).</p><p>+ Phục hồi cây : ${URE1} g urê, ${KCL1} g KCl, ${LNC1} g Lân nung chảy.</p><p>+ Bón mùa khô : ${URE2} g urê, ${KCL2} g KCl, ${BSA} g SA.</p><p>+ Bón thúc bông : ${URE3} g urê, ${KCL3} g KCl, ${BTE3} g trung vi lượng</p><p>+ Bón nuôi trái : ${URE4} g urê, ${KCL4} g KCl, ${BTE4} g trung vi lượng.</p><p>+ Bón thúc trái : ${URE5} g urê, ${KCL5} g KCl, ${LNC5} g Lân nung chảy.</p><p>+ Bón tăng dem : ${URE6} g urê, ${KCL6} g KCl, ${BTE6} g trung vi lượng.</p><p>Bón theo mép tán cây khi đất đủ ẩm và lập nhẹ.</p>`
    }
